...
Console.WriteLine("Press any key to continue, and either 'a' or 'b' when prompted.");
Console.ReadKey();
...
{
    Console.WriteLine("\n You decide to follow path 'b'. The path leads you to a sign stating 'north'. Meaning that you are heading north and you hope to find a way out of the forest. Suddenly, you hear a distant rumble.");
    Console.ReadKey();
...
if (path == ConsoleKey.A)
{
    Console.WriteLine("\n You decide to trust him, following him to an opening that reveals the escape you sought after for so long. It was good to trust him! He led you to freedom!");
    Console.ReadKey();
...
else
{
    ...
    Console.ReadKey();
    Console.WriteLine("\n You find yourself at the edge of the forst, to your left you hear someone exclaim 'Hello, World!' It seems to be the young person from earlier. How could he get here so fast? Are you safe now?");
    Console.ReadKey();
